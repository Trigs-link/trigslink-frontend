export default function Footer() {
  return (
    <footer className="bg-[#09101d] pt-16 pb-12 mt-12 border-t border-white/[0.02]">
      <div className="max-w-[1600px] mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-12 mb-10">
          ...
          <div className="lg:max-w-md">
            <div className="flex items-center gap-2 mb-4 cursor-pointer">
              <img src="/images/full_logo.png" alt="Trigslink Logo" className="h-12 w-auto" />
            </div>
            <p className="text-[#8ba0c2] text-[15px] font-medium tracking-wide leading-relaxed">
          ...
          <div className="lg:min-w-[200px]">
            <h4 className="text-[#4b5e7d] text-[13px] font-bold tracking-wider uppercase mb-6">
              Support & Social
            </h4>
            <div className="flex flex-col gap-4">
              <a href="https://x.com/trigslink" target="_blank" rel="noreferrer" className="text-[#e2e8f0] text-[14px] font-semibold hover:text-[#3b82f6] transition-colors">
                X (Twitter)
              </a>
              <a href="https://youtube.com/@trigslink" target="_blank" rel="noreferrer" className="text-[#e2e8f0] text-[14px] font-semibold hover:text-[#3b82f6] transition-colors">
                YouTube
              </a>
              <a href="https://t.me/trigslink" target="_blank" rel="noreferrer" className="text-[#e2e8f0] text-[14px] font-semibold hover:text-[#3b82f6] transition-colors">
                Telegram
              </a>
              <a href="mailto:trigslink@gmail.com" className="text-[#e2e8f0] text-[14px] font-semibold hover:text-[#3b82f6] transition-colors">
                Email
              </a>
              <a href="/contact" className="text-[#e2e8f0] text-[14px] font-semibold hover:text-[#3b82f6] transition-colors">
                Contact us
              </a>
            </div>
          </div>
        ...
        {/* Bottom Section: Social Icons & Legal Links (DIVIDER LINE ADDED HERE) */}
        <div className="flex flex-col lg:flex-row justify-between items-center gap-6 pt-8 mt-4 border-t border-[#1e2a45]/60">
          
          {/* Social Icons (Raw SVGs) */}
          <div className="flex items-center gap-5 text-[#6a7c9c]">
            ...
            {/* Telegram (Official Airplane Logo) */}
            ...
            <a href="https://t.me/trigslink" target="_blank" rel="noreferrer" className="hover:text-white transition-colors" aria-label="Telegram">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="m20.665 3.717-17.73 6.837c-1.21.486-1.203 1.161-.222 1.462l4.552 1.42 10.532-6.645c.498-.303.953-.14.579.192l-8.533 7.701h-.002l.002.001-.314 4.692c.46 0 .663-.211.921-.46l2.211-2.15 4.599 3.397c.848.467 1.457.227 1.668-.785l3.019-14.228c.309-1.239-.473-1.8-1.282-1.434z"/></svg>
            </a>
          ...
          <div className="flex flex-wrap justify-center lg:justify-end items-center gap-x-3 gap-y-2 text-[13px] font-semibold text-[#5e7090]">
            <span className="text-[#8496b5] mr-2">Trigslink © 2026</span>
            <span className="text-[#2b3b5a]">·</span>
        ...
        {/* New Beta / Validation Disclaimer (DIVIDER LINE ADDED HERE) */}
        <div className="mt-8 pt-6 text-[11.5px] font-medium text-[#4b5e7d] leading-relaxed max-w-[1400px]">
