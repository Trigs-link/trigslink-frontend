      ...
      <div className="max-w-[1600px] mx-auto px-4 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6 justify-end">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Conditional Rendering: Show Premium Badge if Connected, else show Solid Connect Button */}
            {isConnected && address ? (
              ...
              /* --- SOLID SIGN UP / CONNECT BUTTON --- */
              <button 
                onClick={() => open()} 
                className="bg-gradient-to-r from-[#00c2ff] to-[#0066ff] text-white text-[13px] px-6 py-2 rounded-xl font-bold transition-all hover:brightness-110"
              >
                Sign Up
              </button>
